...
namespace RealTimeProject
{
    ...
    public class Frame
    {
        ...
        public bool Compare(Frame other)
        {
            bool sameFrame = true;
            sameFrame = sameFrame && Enumerable.SequenceEqual(inputs, other.inputs);
            sameFrame = sameFrame && Enumerable.SequenceEqual(state.positions, other.state.positions);
            sameFrame = sameFrame && Enumerable.SequenceEqual(state.points, other.state.points);
            sameFrame = sameFrame && Enumerable.SequenceEqual(state.blockFrames, other.state.blockFrames);
            sameFrame = sameFrame && Enumerable.SequenceEqual(state.dirs, other.state.dirs);
            sameFrame = sameFrame && Enumerable.SequenceEqual(state.attacks, other.state.attacks);
            return sameFrame;
        }
